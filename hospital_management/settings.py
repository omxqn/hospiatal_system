...
SECRET_KEY = 'django-insecure-*lefw_!0z*2v=@_xs8_0!pbf-(5fy%3sn0aip1_nn-ld&m-np0'
...
# Define the base URL where your static files will be served from.
STATIC_URL = '/static/'
...
LOGIN_REDIRECT_URL = '/'  # Change this to your desired URL
LOGIN_URL = '/login/'
